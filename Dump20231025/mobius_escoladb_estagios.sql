...
CREATE TABLE `estagios` (
  ...
  CONSTRAINT `estagios_ibfk_1` FOREIGN KEY (`id_empresa`) REFERENCES `empresasregistradas` (`id_empresa`),
  CONSTRAINT `estagios_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `cursos` (`id_curso`)
...
INSERT INTO `estagios` VALUES (1,1,6,'Estágio em Desenvolvimento de Sistemas na Microsoft'),(2,2,5,'Gastronomia'),(3,2,5,'Gastronomia');
